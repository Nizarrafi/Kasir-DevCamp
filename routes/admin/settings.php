...
Route::prefix('settings')->name('settings.')->group(function () {
    ...
    Route::controller(App\Http\Controllers\Settings\ProfileController::class)->prefix('profile')->name('profile.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('update', 'updateProfile')->name('update');
        Route::post('update-password', 'updatePassword')->name('update-password');
    });

    Route::controller(App\Http\Controllers\Settings\StoreSettingController::class)->middleware('can:view_settings_store_setting')->prefix('store')->name('store.')->group(function () {
        Route::get('/', 'index')->name('index');
